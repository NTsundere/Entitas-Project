...
namespace Code.Gameplay.Features.Armaments.Factory
{
    public class  ArmamentFactory : IArmamentFactory
    {
        ...
        private readonly IIdentifierService _identfiers;
        private readonly IStaticDataService _staticDataService;

        public ArmamentFactory(IIdentifierService identfiers, IStaticDataService staticDataService)
        {
            _identfiers = identfiers;
        ...
        public GameEntity CreateVegetableBolt(int level, Vector3 at)
        {
            ...
            return CreateProjectileEntity(at, abilityLevel, setup)
                    .AddParentAbilty(AbilityId.VegetableBolt)
        ...
        public GameEntity CreateMushroom(int level, Vector3 at, float phase)
        {
            ...
            return CreateProjectileEntity(at, abilityLevel, setup)
                    .AddParentAbilty(AbilityId.OrbitingMushroom)
                    .AddOrbitPhase(phase)
        ...
        public GameEntity CreateEffectAura(AbilityId parentAbilityId, int producerId, int level)
        {
            ...
            return CreateEntity.Empty()
                .AddId(_identfiers.Next())
                .AddParentAbilty(parentAbilityId)
