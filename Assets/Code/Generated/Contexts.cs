...
public partial class Contexts {
    ...
    public const string ParentAbilty = "ParentAbilty";
    ...
    public void InitializeEntityIndices() {
        ...
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, Code.Gameplay.Features.Abilities.AbilityId>(
            ParentAbilty,
            game.GetGroup(GameMatcher.ParentAbilty),
            (e, c) => ((Code.Gameplay.Features.Abilities.ParentAbiltyComponent)c).Value));
    }
}
...
public static class ContextsExtensions {
    ...
    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithParentAbilty(this GameContext context, Code.Gameplay.Features.Abilities.AbilityId Value) {
        return ((Entitas.EntityIndex<GameEntity, Code.Gameplay.Features.Abilities.AbilityId>)context.GetEntityIndex(Contexts.ParentAbilty)).GetEntities(Value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
